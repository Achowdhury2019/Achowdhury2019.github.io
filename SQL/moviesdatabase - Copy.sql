...
select count (*) from movie_revenues union 
...
VALUES ('Dave', 'Michelle','ewarsin@gmail.com','GBR',43)

INSERT INTO examples(first_name,last_name,email,nationality,age)
VALUES ('Emily','Watson','emilyw@gmail.com','USA',20),
	('John','Smith','smith@gmail.com','AUS',56),
	('Jack','Burr','jj@gmail.com','USA',39),
	('Jim','Johnson','jimj@gmail.com','GER',29)
...
UPDATE examples 
SET email='emilywatson@gmail.com'
WHERE example_id = 2;
...
UPDATE owners 
SET first_name=NULL and city =NULL
WHERE id=7

UPDATE owners 
SET email ='johnoliver@gmail.com'
WHERE id=3
...
INSERT INTO owners(id,first_name,last_name,city,state,email)
VALUES (7,'','Maxwell','','CA','lordmaxwell@gmail.com')
SELECT * from owners;
...
select * from examples
where example_id > 2 and example_id< 8

in, like, between

SELECT first_name,last_name from examples

SELECT first_name,last_name, nationality from directors

SELECT * FROM movies
WHERE movie_lan='English' or movie_lang='chinese'

SELECT * FROM movies
WHERE age_certificates ='15' AND movie_lang='English'

SELECT * FROM movies
WHERE age_certificates ='15' AND movie_lang='English' AND director_id!=4;

SELECT movie_name, movie_length FROM movies
WHERE movie_length >= 120 AND movie_length <= 160
...
SELECT movie_name, movie_length FROM directors
WHERE movie_lang IN ('English', 'Chinese')

SELECT * FROM actors
WHEREfirst_name IN ('Bruce','John')

SELECT * FROM actors
WHERE actor_id IN (2,3,4)

CREATE TABLE director_temp
...
SELECT * FROM movies
WHERE release_date BETWEEN '1995-28-01' AND '1999-12-31'
