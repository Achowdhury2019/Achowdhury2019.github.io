...
INSERT INTO movies_actors (movie_id,actor_id) VALUES ('1','52'),
('2','50'),
('3','23'),
('4','26'),
('5','14'),
...
INSERT INTO movie_revenues (revenue_id, movie_id, domestic_takings,
international_takings) VALUES ('1','45','22.2','1.3'),
('2','13','199.4','201.2'),
('3','23','102.1',null),
('4','44','158.7',null),
('6','1','27.1',null),
...
age_certificate, director_id) VALUES ('A Clockwork
...
FROM actors a
INNER JOIN movies
ON movies.movie_id=a.actors_id;
INNER JOIN directors
ON Orders.CustomerID=Customers.CustomerID;

--2--
SELECT d.first_name, d.last_name,SUM(mr.domestic_takings)
FROM directors d
FULL JOIN movies m
USING (director_id)
FULL JOIN movie_revenues mr
USING (movie_id)
...
--2--
SELECT age_certificate FROM movies

SELECT movie_name,movie_length, age_certificate from movies 
WHERE age_certificate like '[^0-9]%' > (SELECT AVG(movie_length) from movies
