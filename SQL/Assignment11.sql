...
CREATE TABLE movie_revenues(
		...
		movie_id INT REFERENCES movies_actors(movie_id),
...
VALUES('Tomas','Alfredson','1965-04-01','Swedish'),
	...
	CREATE TABLE movies(
		...
		movie_id INT REFERENCES movie_revenues(movie_id)
	);
...
SELECT movie_length, movie_lang FROM movies
...
---Lining the number of records returned--
...
--offset takes out the first 10 shows from 11-20
SELECT * FROM movie_revenues
ORDER BY revenue_id
LIMIT 10 OFFSET 10;
...
SELECT DISTINCT movie_lang, age_certificates FROM movies 
ORDER BY movie_lang
...
--SELECT Columns AS new _columns FROM table

SELECT international_takings AS intT FROM movie_revenues
WHERE international_takings > 300;

SELECT last_name AS surname FROM directors
WHERE last_name LIKE 'A%'
ORDER BY last_name;

--two diff string connect together is called concadinate--

SELECT 'concat' || 'tog' AS new_string

SELECT 'concat' || '' || 'tog' AS new_string

SELECT CONCAT(first_name,' ',last_name) AS full_name FROM actors
SELECT CONCAT_WS(' ',first_name,last_name,gender) AS full_name FROM actors
...
--count, sum, min, max, average functions
...
SELECT COUNT(DISTINCT international_takings) FROM movie_revenues;
...
--SELECT SUM(movie_name) FROM movies   --not exist--
--SELECT SUM(*) --not exist--

SELECT MAX(movie_length) FROM movies
SELECT MIN(movie_length) FROM movies

SELECT MIN(movie_length) FROM movies
WHERE movie_length='Japanese'

SELECT AVG(movie_length) FROM movies

SELECT AVG(movie_length) FROM movies
WHERE movie_length='Japanese' and age_certificate='18'
...
add director_id serial primary key
...
--1--
SELECT nationality, COUNT(first_name) FROM directors
...
--Jan 30--
/*
SELECT columnname,column2...FROM TABLE 1
JOIN
TABLE 2
ON TABLE1.director_id = 
*/

SELECT * FROM directors
INSERT INTO directors (first_name, last_name, date_of_birth, nationality)
VALUES ('Chiristopher', 'Nolan', '1970-07-30', 'Britain');
